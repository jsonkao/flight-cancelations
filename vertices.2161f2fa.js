...
exports.compute_geojson = compute_geojson;
...
function compute_geojson(buffer) {
  // First 4 bytes contain the number of "indices"
  const count = new Uint32Array(buffer, 0, 1)[0]; // Next 4 * count bytes stores the indices
...
function compute_vertices(buffer) {
  ...
  const coords = new Float32Array(buffer, 4 * (indices.length + 1));
  const vertices = [];
  let v = 0; // Seems like this is constructing an array of pairs of coordinates.
...
async function test() {
  const res = await fetch('https://static01.nyt.com/newsgraphics/2020/02/04/coronavirus-flights/67d5b188d41684d2a82da11e94e358b4a769735e/geometry/borders.dat');
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","vertices.js"], null)
//# sourceMappingURL=/vertices.2161f2fa.js.map